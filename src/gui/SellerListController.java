...
public class SellerListController implements Initializable, DataChangeListener {
	...
	private void createDialogForm(Seller obj, String absoluteName, Stage parentStage) {
		try {
			...
			controler.setService(new SellerServices(), new DepartmentServices());
			...
			dialogStage.setResizable(false); // não pode redimencionar a janela == false
			dialogStage.initOwner(parentStage); // quem será o pai da janela
			...
			e.printStackTrace();
			Alerts.showAlert("IO Exceptin", "Error loading view", e.getMessage(), AlertType.ERROR);
		}
	}
